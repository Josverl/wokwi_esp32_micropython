...
port_info_list: List[PortDiskInfo] = [
    PortDiskInfo("esp32-generic", start_address=0x0020_0000, image_size=0x0020_0000, flash_size=0x40_0000),  # 4MB
    PortDiskInfo("rp2-pico_w", start_address=0x1012_C000, end_address=0x1020_0000),  # pico_w = 0x1012c000-0x10200000 (848K)
    # NOT VERIFIED
    PortDiskInfo("esp32-ota", start_address=0x0031_0000, image_size=0x000F_0000, flash_size=0x40_0000),  # 4MB-OTA
    PortDiskInfo("esp32-s3-generic", start_address=0x0020_0000, image_size=0x0060_0000, flash_size=0x80_0000),  # 8MB
